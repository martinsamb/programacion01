        ...
        while(!feof(pFile))
        {
            ...
            if(llamada != NULL)
            {
                if(isValidInter(auxId)&&
                   isValidFecha(auxFecha)&&
                   isValidInter(auxNumeroCliente)&&
                   isValidInter(auxIdProblema)&&
                   isValidName(auxSolucion))
                {
                    auxLlamada.id = atoi(auxId);
                    strcpy(auxLlamada.fecha,auxFecha);
                    auxLlamada.numeroCliente = atoi(auxIdProblema);
                    ...
                    {
                        ll_add(this,llamada); // agrega un elemento al ll
                    }
                    else
                    {

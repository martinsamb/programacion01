...
* \param array llamada Array of llamada
...
* \param array llamada Array de llamada
...
int llamada_alta(Llamada array[], int size, int* contadorID)                          //cambiar llamada
{
    ...
    {
        if(llamada_buscarEmpty(array,size,&posicion)==-1)                          //cambiar llamada
        {
...
int llamada_baja(Llamada array[], int sizeArray)                                      //cambiar llamada
{
    ...
    if(array!=NULL && sizeArray>0)
    {
        ...
        if(llamada_buscarID(array,sizeArray,id,&posicion)==-1)                                   //cambiar si no se busca por ID
        {
...
*
*/
int llamada_bajaValorRepetidoInt(Llamada array[], int sizeArray, int valorBuscado) //cuando hay que dar de baja todas las posiciones en las que se encuentra ese int
{
    int retorno=-1;
    int i;
    if(array!=NULL && sizeArray>0)
...
*
*/
int llamada_listar(Llamada array[], int size)                      //cambiar llamada
{
    int retorno=-1;
    int i;
    if(array!=NULL && size>=0)

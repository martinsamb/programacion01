...
/**
    ...
    Funcion para filtrar elementos listaFiltrada = al_filter(listaEmpleados, funcionCriterioFiltro)
    Si el elemento devuelve el elemento
*/
...
LinkedList* al_filter(LinkedList this, funcion)
{
    ...
    for(i=0; i<ll_len();i++)
    {
        ...
        if(funcion(el)==1)
        {
            //agregar "el" a la lista nueva que voy a devolver

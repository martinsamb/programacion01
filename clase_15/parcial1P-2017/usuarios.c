...
#include <stdlib.h>
#include "utn.h"
#include "usuario.h" //cambiar por nombre entidad
...
int usuario_buscarID(Usuario array[], int size, int valorBuscado, int* posicion)                    //cambiar usuario
{
    ...
    if(array!= NULL && size>=0)
    {
        for(i=0;i<size;i++)
        {
            if(array[i].isEmpty==1)
                continue;
            else if(array[i].idUsuario==valorBuscado)                                                   //cambiar campo ID
            {
                retorno=0;
                *posicion=i;
                break;
...
int usuario_alta(Usuario array[], int size, int* contadorID)                          //cambiar usuario
{
    ...
    if(array!=NULL && size>0 && contadorID!=NULL)
    {
        ...
        else
        {
            ...
            utn_getUnsignedInt("\nCalificaciones: ","\nError",1,sizeof(int),1,1,1,&array[posicion].calificaciones);
            printf("\nId Usuario: %d\nNombre: %s\nPasword: %s\nCalificacion: %d",
                   array[posicion].idUsuario,
                   array[posicion].nombre,
                   array[posicion].password,
                   array[posicion].calificaciones);
            retorno=0;
        }
    }
    return retorno;
...
int usuario_baja(Usuario array[], int sizeArray)                                      //cambiar usuario
{
    ...
    if(array!=NULL && sizeArray>0)
    {
        ...
        else
        {
            ...
            array[posicion].idUsuario=0;                                                                   //cambiar campo id
            array[posicion].calificaciones=0;                                                               //cambiar campo varInt                                                            //cambiar campo varFloat
            strcpy(array[posicion].nombre,"");                                                   //cambiar campo varString
            strcpy(array[posicion].calificaciones,"");                                               //cambiar campo varLongString
            retorno=0;
        }
    }
    return retorno;

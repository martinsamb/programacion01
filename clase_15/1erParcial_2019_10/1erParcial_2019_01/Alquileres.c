...
* \param array alquiler Array of alquiler
...
* \param array alquiler Array de alquiler
...
*
*/
int alquiler_buscarCliente(Alquiler array[], int size, int valorBuscado, int* posicion)                    //cambiar alquiler
{
    int retorno=-1;
    int i;
    if(array!= NULL && size>=0)
...
*
*/
int alquiler_buscarJuego(Alquiler array[], int size, int valorBuscado, int* posicion)                    //cambiar alquiler
{
    int retorno=-1;
    int i;
    if(array!= NULL && size>=0)
    {
        for(i=0;i<size;i++)
        {
            if(array[i].isEmpty==1)
                continue;
            else if(array[i].idJuego==valorBuscado)                                                   //cambiar campo varInt
            {
                retorno=0;
                *posicion=i;
                break;
...
int alquiler_alta(Alquiler array[], int size, int* contadorID)                          //cambiar alquiler
{
    ...
    {
        if(alquiler_buscarEmpty(array,size,&posicion)==-1)                          //cambiar alquiler
        {
        ...
        else
        {
            ...
            utn_getUnsignedInt("\nID Juego: ","\nError",1,sizeof(int),1,1,1,&array[posicion].idJuego);
            utn_getUnsignedInt("\nID Cliente: ","\nError",1,sizeof(int),1,1,1,&array[posicion].idCliente);
            utn_getDate("\nFecha: ", "\nError",1, array[posicion].Fecha);
            printf("\nID: %d\nID Juego: %d\nID Cliente: %d\nFecha: %d",
                   array[posicion].idUnico,
                   array[posicion].idJuego,
...
int alquiler_baja(Alquiler array[], int sizeArray)                                      //cambiar alquiler
{
    ...
    if(array!=NULL && sizeArray>0)
    {
        ...
        if(alquiler_buscarID(array,sizeArray,id,&posicion)==-1)                                   //cambiar si no se busca por ID
        {
...
*/
/*
int alquiler_bajaValorRepetidoInt(Alquiler array[], int sizeArray, int valorBuscado) //cuando hay que dar de baja todas las posiciones en las que se encuentra ese int
{
    int retorno=-1;
    int i;
    if(array!=NULL && sizeArray>0)
